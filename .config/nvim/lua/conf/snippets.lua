...
ls.snippets = {
    all = {
        ...
        s({trig = 'fn'}, {
            ...
            c(1, {t({'public '}), t({'private '})}), t({'class '}), i(2),
            t({' '}), c(3, {
                t({'{'}),
        ...
        ls.parser.parse_snippet({trig = 'lspsyn'},
                                'Wow! This ${1:Stuff} really ${2:works. ${3:Well, a bit.}}'),

        -- When wordTrig is set, snippets only expand as full words (lte won't expand, te will).
        ls.parser.parse_snippet({trig = 'te', wordTrig = true},
                                '${1:cond} ? ${2:true} : ${3:false}'),

        -- When regTrig is set, trig is treated like a pattern, this snippet will expand after any number.
        ls.parser.parse_snippet({trig = '%d', regTrig = true, wordTrig = true},
                                'A Number!!'),
    ...
    java = {
        ...
        s({trig = 'fn'}, {
            ...
            c(1, {t({'public '}), t({'private '})}), c(2, {
                t({'void'}), t({'String'}), t({'char'}), t({'int'}),
                t({'double'}), t({'boolean'}), i(nil, {''})
